import { Box, Button, FormControl, FormLabel, Image, Input, Stack, Text, useToast } from '@chakra-ui/react'; // form imports
              ...
              <Stack direction={['column', 'row']} align={{ base: 'start', sm: 'center' }}>
                ...
                {previewImage && (
                  <Box boxSize="" className="margin-auto" justifyContent="center">
                    <Image boxSize="40%" objectFit="contain" src={previewImage} className="margin-auto" alt="logo" />
                  </Box>
                )}
              </Stack>
            </FormControl>
